 ...
 *
 * This class handles the initialization of the ONNX environment and session, preprocessing
 * of images (including letterboxing and normalization), inference, and post-processing
